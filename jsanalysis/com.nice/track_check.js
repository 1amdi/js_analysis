    ...
    // 验证码轨迹加密方法，需要鼠标滑动轨迹
        ...
        trackMoving = function(e) {
            ...
            // if (true) {
                ...
                var n = 939
                , i = 122
                , r = f_(token, [Math.round(e.clientX - n), Math.round(e.clientY - i), (new Date()).getTime() - this.beginTime] + "");
...
var run_track = function (track_move, click_track){
    for (let index = 0; index < track_move.length; index++) {
        trackMoving(track_move[index])    
    }
